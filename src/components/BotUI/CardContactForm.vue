<template>
  <div v-show="showFlag" class="sc-contact--information">
    <div class="sc-inventory--element-icon">
      <img v-if="data.image_url" :src="data.image_url" class="sc-image">
    ...
    <div class="sc-inventory--element-details">
      <div class="sc-inventory--element-stock">
        <div v-if="data.vin" class="sc-inventory--element-text">{{ 'VIN#' + data.vin }}</div>
        <div v-if="data.stock" class="sc-inventory--element-text">{{ 'Stock#' + data.stock }}</div>
