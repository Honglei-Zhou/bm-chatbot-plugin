  ...
  >
    ...
    >
      ...
      <div v-else class="sc-message--ls-wrap">
        <div
          :style="messageColors"
          class="sc-message--ls-card-title"
        >
          {{ message.title }}
        </div>
        <div class="sc-message--ls-card-wrap">
        ...
        <div v-if="message.buttons && message.buttons.length > 0" class="sc-message--ls-button-wrap">
          ...
          <button
            :style="messageColors"
            :key="idx"
            class="sc-message--ls-button-price"
            @click="openContactForm(message)"
          >GET BEST PRICE</button>
        </div>
        <!-- <div class="sc-message--ls-button-wrap">
          <button
            :style="messageColors"
            :key="idx"
            class="sc-message--ls-button"
    ...
    <CardContactForm ref="contactForm" :data="cardMessage"/>
  </div>
</template>

<script>
import CardContactForm from '@/components/BotUI/CardContactForm'
export default {
  components: {
    CardContactForm
  },
  ...
  methods: {
    ...
    openContactForm(message) {
      // this.$emit('openContactForm', message)
      console.log(message)
